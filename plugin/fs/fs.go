...
type FileSystem interface {
	http.FileSystem
	ReadFile(name string) ([]byte, error) // See ioutil.ReadFile documentation.

	setOption(name string, value []string) error // SetOption is used in the setup of the fs plugin.
}
